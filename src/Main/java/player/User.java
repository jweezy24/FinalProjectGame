...
public class User {
  ...
  public void levelUp() {
    ...
    System.out.println(
        "Enter the skill then the amount (strength 10) this will add 10 skill points to strength");
    System.out.println(
        "How to pick the stat you want, type strength, intel for intelligence, or stamina");
